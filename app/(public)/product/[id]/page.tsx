...
const Page = () => {
  ...
  const onTouchEnd = () => {
    ...
    if (isLeftSwipe || isRightSwipe) {
      ...
      // Update the current image index after a short delay to allow for animation
      setTimeout(() => {
    ...
    <div className="productmain flex py-[20px] justify-center bg-white px-[4%] w-full flex-col items-center gap-[10px]">
      ...
      <div className="productmain2 w-full flex items-start justify-center mt-[20px] gap-[20px]">
        ...
        <div className="productimgbox2 w-[100%] flex flex-col">
          ...
          >
            {/* Image carousel with improved transitions */}
            <div
          ...
          <div className="flex w-[100%] items-center justify-start p-[10px] gap-[10px] overflow-x-auto">
            {product.images.map((image, index) => (
              <div
                key={index}
                className={`productimg12 relative w-[60px] h-[70px] cursor-pointer flex-shrink-0 transition-all duration-200 ${
                  currentImageIndex === index ? "ring-2 ring-black scale-105" : ""
                }`}
                onClick={() => goToImage(index)}
              >
                <Image
        ...
        <div className="productinfo flex flex-col gap-[20px]">
          <div className="w-full flex items-center justify-between">
            ...
            <div className="flex gap-2">
              <Share2 onClick={handleShare} className="cursor-pointer text-gray-500 hover:text-black" size={18} />
              <Heart
          ...
          <div className="size w-full flex flex-col gap-[20px]">
            ...
            <div className="flex w-full items-center justify-start flex-wrap gap-[20px]">
              {product.raw_tshirt_ids.map((rawTshirt) => (
                <button
                  key={rawTshirt.id}
                  className={`border border-gray-300 flex items-center justify-center w-[80px] h-[37px] font-regular text-md ${
                    selectedSize === rawTshirt.size ? "bg-gray-200" : ""
          ...
          <div className="shipping text-gray-500 flex flex-col items-start justify-start gap-2">
            ...
            <div className="text-xs flex flex-col items-start justify-start gap-1">
              <p>
                • <b>Delivery Timeline:</b> 4 to 7 working days
              </p>
            </div>
          </div>
          ...
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="item-1">
              ...
              <AccordionContent className="text-xs flex flex-col items-start justify-start gap-3">
                <div className="shipping text-black flex flex-col items-start justify-start gap-2">
                  ...
                  <div className="text-xs flex flex-col items-start justify-start gap-1">
                    <p>
                      • <b>Composition:</b> 100% Cotton <b>(French Terry)</b>
                    </p>
                    <p>
                      • <b>GSM:</b> 250 GSM
                    </p>
                ...
                <div className="shipping text-black flex flex-col items-start justify-start gap-2">
                  ...
                  <div className="text-xs flex flex-col items-start justify-start gap-1">
                    ...
                    <p>
                      • <b>Fit:</b> Oversized drop shoulder tee
                    </p>
                  </div>
                </div>
              </AccordionContent>
            ...
            <AccordionItem value="item-3">
              ...
              <AccordionContent className="text-xs">
                <div className="text-xs flex flex-col items-start justify-start gap-1">
                  <p>
                    • <b>Return/Exchange Period:</b> Within 7 days of delivery
                  </p>
                  <p>
                    • <b>Product Condition:</b> Unworn, unwashed, with tags intact
                  </p>
                  <p>
                    • <b>Quality Check:</b> Defective products can be returned/exchanged
                  </p>
                  <p>
                    • <b>Reverse Shipping:</b> Customer pays return shipping, unless defective
                  </p>
                  <p>
                    • <b>Exchange Option:</b> Size/color exchange based on availability
                  </p>
                </div>
              </AccordionContent>
            </AccordionItem>
